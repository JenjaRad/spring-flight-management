...
public interface FlightRepository extends JpaRepository<Flight, Long> {
    ...
    @Query(value = "select difference.id , difference.destination_country from flight_schema.flight as difference where status like 'COMPLETED' " +
            "AND difference.ended_at > estimated_date_type ", nativeQuery = true)
